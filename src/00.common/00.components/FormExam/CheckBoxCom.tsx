          ...
          <Row>
            <Col span={24}>
              ...
              {this.props.answerTitle && this.props.answerTitle.length > 0 && (
                <span style={{ color:"blue"}}>{this.props.answerTitle[0]}</span>
              )}
            </Col>
            <Col span={24}>
              <Checkbox value="0100">B</Checkbox>
              {this.props.answerTitle && this.props.answerTitle.length > 0 && (
                <span style={{ color:"blue"}}>{this.props.answerTitle[1]}</span>
              )}
            </Col>
            <Col span={24}>
              <Checkbox value="0010">C</Checkbox>
              {this.props.answerTitle && this.props.answerTitle.length > 0 && (
                <span style={{ color:"blue"}}>{this.props.answerTitle[2]}</span>
              )}
            </Col>
            {this.props.haveAnswerD && (
              <Col span={24}>
                ...
                {this.props.answerTitle &&
                  this.props.answerTitle.length > 0 && (
                    <span style={{ color:"blue"}}>{this.props.answerTitle[3]}</span>
                  )}
              </Col>
            )}
          </Row>
